    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/commodity/api/save/${commodity.id}" onsubmit="return false;" autocomplete="off">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt ipt" name="summary" value="${commodity.comAbstract}" placeholder="2-140字符"／>
                </div>
            </div>
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt"  name="image" value="${commodity.picUrl}" placeholder="图片地址"/>
                </div>
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <textarea class="u-ipt" name="detail" rows="10" placeholder="2-1000个字符">${commodity.detail}</textarea>
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">价格：</label>
                <div class="fmipt">
                    <input class="u-ipt price" name="price" value="${commodity.perPrice?c}"/>元
                </div>
            </div>
